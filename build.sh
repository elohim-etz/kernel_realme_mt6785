...
curl -LSs "https://raw.githubusercontent.com/backslashxx/KernelSU/12096+155/kernel/setup.sh" | bash -s 12096+155
...
function rclone_upload()
{
    ...
    cd AnyKernel
    zip -r9 MahiruShiina-102-4.14.356-$d-RM6785-ksu.zip *
}
